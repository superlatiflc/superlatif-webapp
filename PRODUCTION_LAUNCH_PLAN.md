...
| ------ | ---------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- |
| **M1** | **Production authentication (OD-02)**                      | **Built, not activated (ADR-072).** WordPress one-time bridge behind `FEATURE_STUDENT_LOGIN=false`. Production still renders "Masuk belum tersedia". Needs the OD-02 spike (`wordpress-plugins/superlatif-app-bridge/README.md`), then plugin install + secret + flag. | Founder + Eng Lead        |
