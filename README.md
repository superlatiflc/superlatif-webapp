...
| `packages/domain/src/commerce`      | Pure domain: bundle composition, offer sale-state, SKU mapping resolution (COM-001); webhook HMAC verification, payload redaction, canonical-event/provider-status-map normalization (COM-002)                                                                       |
...
| `packages/db`                       | Drizzle schema dan migration (IDN-001: identity; ENT-001: access; COM-001: commerce; IDN-004: authorization; ENT-004: access-change; PRG-001: program; PRG-002: curriculum; LRN-001: assets/recordings/delivery; COM-002: raw/normalized/quarantine commerce events) |
