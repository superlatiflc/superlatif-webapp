...
| `packages/domain/src/program`       | Pure domain: next-action resolver, primary-program selection, Program Hub tab visibility (PRG-001); release rules, module visibility, circular-prerequisite check (PRG-002) |
| `packages/domain/src/shared`        | Canonical-JSON checksum shared by access/ and commerce/ (promoted in COM-001)                                                                                               |
| `packages/db`                       | Drizzle schema dan migration (IDN-001: identity; ENT-001: access; COM-001: commerce; IDN-004: authorization; ENT-004: access-change; PRG-001: program; PRG-002: curriculum) |
